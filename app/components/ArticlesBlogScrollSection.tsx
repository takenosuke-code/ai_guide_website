    ...
    <section className="py-8 md:py-12">
      <Container>
        ...
        <div className="relative" style={{ minHeight: '500px', paddingTop: '20px', paddingBottom: '40px' }}>
          ...
          {/* Button - centered on the page, positioned right under white container */}
          <div className="flex justify-center relative z-[100] pointer-events-auto" style={{ marginTop: '-50px', isolation: 'isolate' }}>
            <Link
              href="/articles"
              className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-3 rounded-lg transition-colors shadow-md relative z-[100] pointer-events-auto"
              onClick={(e) => {
                e.stopPropagation();
              }}
            >
