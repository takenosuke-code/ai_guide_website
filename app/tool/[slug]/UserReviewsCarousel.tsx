...
export default function UserReviewsCarousel({ reviews }: UserReviewsCarouselProps) {
  ...
  const scroll = (direction: 'left' | 'right') => {
    if (scrollContainerRef.current) {
      const cardWidth = scrollContainerRef.current.clientWidth / 2; // Show 2 cards at a time
  ...
  return (
    <div className="relative">
      ...
      {/* Scrollable Container - Shows 2 cards at a time */}
      <div
